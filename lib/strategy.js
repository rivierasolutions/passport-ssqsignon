 ...
 * @api public
 */
function Strategy(options, module, scopePresenter) {
  if (typeof options == 'string') {
    scopePresenter = module;
    module = options;
    options = {};
  }
  ...
  this.name = 'ssqsignon';
  this._verify = buildVerify(module, scopePresenter);
...
function buildVerify(module, scopePresenter) {
